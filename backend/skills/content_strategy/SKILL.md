...
description: |
  Builds content roadmaps, editorial plans, topic clusters, and gap priorities around traffic, authority, visibility, audience, and business goals. Use when the user needs a coordinated content program. Do NOT use for writing a single draft, metadata-only work, or technical site audits.
---
